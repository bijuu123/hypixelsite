...
! function(g, q, r) {
    XF.activate ? console.error("XF core has been double loaded") : (XF.browser || (XF.browser = {
        ...
        onPointer: function(a, b) {
            ...
            this.off("pointerdown.pointer-watcher").on("pointerdown.pointer-watcher", function(d) {
                ...
                switch (b.css("position")) {
                    ...
                    case "-webkit-sticky":
                        var c = b.dimensions(!0),
                            ...
                            e = b.css("top"),
                            d = b.css("bottom");
                        if ("auto" !== e && (e = c.top - f.top - parseInt(e, 10), .5 >= e && -.5 <= e) || "auto" !== d && (e = c.bottom - f.bottom - parseInt(d, 10), .5 >= e && -.5 <= e)) return a = b, !1
                }
            });
            return a
        },
        ...
        isElementVisible: function(a) {
            ...
            return 0 <= a.top && 0 <= a.left && a.bottom <= g(q).height() && a.right <= g(q).width()
        },
        ...
        ajax: function(a, b, c, f, e) {
            ...
            var d = !0,
                h = !0,
                k = !0;
            e && (e.skipDefault && (h = d = !1, delete e.skipDefault), e.skipDefaultSuccessError && (h = !1, delete e.skipDefaultSuccessError), e.skipDefaultSuccess && (d = !1, delete e.skipDefaultSuccess), e.skipError && (k = !1, delete e.skipError));
        ...
        defaultAjaxSuccessError: function(a, b, c) {
            ...
            return a.errorHtml ? (XF.setupHtmlInsert(a.errorHtml, function(f, e) {
        ...
        getOverlayHtml: function(a) {
            ...
            g.isPlainObject(a) && (b = g.extend({}, b, a), a.html && (a = a.html));
            ...
            if (!a.is(".overlay")) {
                ...
                f.length && (a = f);
                f = g('<div class="overlay" tabindex="-1"><div class="overlay-title"></div><div class="overlay-content"></div></div>');
        ...
        getLocalLoadTime: function() {
            ...
            e || (q.performance && q.performance.timing && 0 !== q.performance.timing.requestStart ? (e = q.performance.timing, e = Math.floor((e.requestStart + e.responseStart) / 2E3)) : e = Math.floor((new Date).getTime() / 1E3) - 1, b.val(e + "," + a.now));
        ...
        function a(e) {
            ...
            if (e.key === d) {
                ...
                if (h && h.event && (e = h.event, h = h.data || null, d = b[e])) {
                    f = e;
                    ...
                    if (!a) {
                        ...
                        var u = function(B) {
                                b = XF.ajax("post", y, B ? {
                                    ...
                                    A.jobRunner ? (g("#xfManualJobStatus").text(A.jobRunner.status || XF.phrase("processing...")), setTimeout(function() {
                                        u(B)
                                    }, 0)) : z()
                                }, {
                                    skipDefault: !0
        ...
        var a, b, c, f, e, d, h = !1,
            ...
            l = function(n) {
                ...
                for (var y = 0; y < t; y++) {
                    ...
                    var B = b - z + x;
                    var A = w.xfDynType; - 2 > B ? (B = z - (b + x), 60 > B ? "futureMoment" != A && (u.text(XF.phrase("in_a_moment")), w.xfDynType = "futureMoment") : 120 > B ? "futureMinute" != A && (u.text(XF.phrase("in_a_minute")), w.xfDynType = "futureMinute") : 3600 > B ? (z = Math.floor(B / 60), A !== "futureMinutes" + z && (u.text(XF.phrase("in_x_minutes", {
                        "{minutes}": z
        ...
        var a, b, c = !1,
            ...
            m = function(l) {
                l.csrf && (XF.config.csrf = l.csrf, g("input[name=_xfToken]").val(l.csrf));
            ...
            b = function(c) {
                if (XF.config.enableRtnProtect && !c.isDefaultPrevented()) {
                    ...
                    if (e && (!e.match(/^[a-z]:/i) || e.match(/^https?:/i)) && !f.is("[data-fancybox]")) {
                        ...
                        if (!(f.closest("[contenteditable=true]").length || (e = XF.canonicalizeUrl(e), (new RegExp("^[a-z]+://" + location.host + "(/|$|:)", "i")).test(e) || d && d == c.timeStamp || (f.data("blank-handler-last", c.timeStamp), h = navigator.userAgent, f = -1 !== h.indexOf("MSIE"), d = -1 !== h.indexOf("Safari") && -1 == h.indexOf("Chrome"), h = -1 !== h.indexOf("Gecko/"), c.shiftKey && h || d && (c.shiftKey || c.altKey) || f)))) {
                            if (d) f = g('<iframe style="display: none" />').appendTo(r.body), d = f[0].contentDocument || f[0].contentWindow.document, d.__href = e, e = g("<script />", d), e[0].text = "window.opener=null;window.parent=null;window.top=null;window.frameElement=null;window.open(document.__href).opener = null;", d.body.appendChild(e[0]), f.remove();
                            else {
                                e = q.open(e);
                                try {
                                    e.opener = null
        ...
        function c(d) {
            ...
            if (XF.Keyboard.isShortcutAllowed(r.activeElement) && (!e.hasOwnProperty(d.key) || 0 != (0 +
                    d.ctrlKey ? 1 : 0 + d.altKey ? 2 : 0 + d.metaKey ? 4 : 0) || !f(e[d.key])) && e.hasOwnProperty(d.which)) {
        ...
        return {
            initialize: function() {
                XF.PWA.isSupported() && (XF.config.skipServiceWorkerRegistration ? h = new Promise(function(l, p) {
                    ...
                    else if (l = p.type, p = p.payload, "string" !== typeof l || "" === l) console.error("Invalid message type:", l);
        ...
        return {
            ...
            hasUserPreviouslySubscribed: function(d) {
                return XF.Push.getPushHistoryUserIds().hasOwnProperty(d || XF.config.userId)
            },
            ...
            handleToggleAction: function(d, h, k, m) {
                XF.Push.isSubscribed ? XF.Push.handleUnsubscribeAction(d, h) : XF.Push.handleSubscribeAction(!1, k, m)
            },
                ...
                if (f) {
                    ...
                    if (!c.data("expand-check-triggered") && (c.data("expand-check-triggered", !0), c.find("img").one("load", h), q.MutationObserver)) {
                        ...
                        var p = new MutationObserver(function(n) {
                            c.hasClass("is-expanded") ? p.disconnect() : m && (k && clearTimeout(k), k = setTimeout(l, 200))
                        });
                        p.observe(this, {
                            attributes: !0,
                            childList: !0,
        ...
        function a() {
            function e(h) {
                ...
                var m = k.indexOf("\n"); - 1 !== m && (k = k.substring(0, m), d = null === d ? k.length : d + k.length, d++, XF.UnfurlLoader.handleResponse(JSON.parse(k)), d < h.length && e(h))
            }
            if (b.length && !c) {
                var d = null;
                c = !0;
        ...
        return {
            watch: function(e) {
                ...
                b.hasOwnProperty(e) || (b[e] = !0, g(r).on(e, "[data-xf-" + e + "]", function(h) {
            ...
            if (b) {
                ...
                for (e in b)
                    if (b.hasOwnProperty(e)) {
                        ...
                        this.options.clickAttacher ? this.options.clickAttacher(h, XF.proxy(this, "resultClick")) : h.click(XF.proxy(this, "resultClick"));
                        var k = {
                            icon: "",
                            text: "",
                            desc: ""
                ...
                if (this.$results.children().length) {
                    ...
                    this.headerHtml && (h = g("<li />").addClass("menu-header menu-header--small").attr("unselectable", "on").html(this.headerHtml), h.prependTo(this.$results));
...
! function(e, l, m, u) {
        ...
        if (b.switchKey) {
            ...
            if (d) {
                for (var g, h; g = d.match(/(\s*,)?\s*(addClass|removeClass|titleAttr):([^,]+)(,|$)/);)
                    if (d = d.substring(g[0].length), h = e.trim(g[3]), h.length) switch (g[2]) {
                        case "addClass":
                            a.addClass(h);
                            break;
                        case "removeClass":
    ...
    XF.Preview = XF.Element.newHandler({
        ...
        preview: function(a) {
            ...
            var b = this;
            XF.ajax("post", this.options.previewUrl, this.$target.serializeArray(), function(c) {
    ...
    XF.ShareButtons = XF.Element.newHandler({
        ...
        setupPageData: function() {
            ...
            this.options.pageUrl && this.options.pageUrl.length ? this.pageUrl = this.options.pageUrl : (this.pageUrl = e('meta[property="og:url"]').attr("content"), this.pageUrl || (this.pageUrl = l.location.href));
        ...
        focus: function(a) {
            ...
            if (!b.attr("href") && !b.is(".shareButtons-button--share")) {
                ...
                c = c.replace("{url}", encodeURIComponent(this.pageUrl)).replace("{title}", encodeURIComponent(this.pageTitle)).replace("{desc}", encodeURIComponent(this.pageDesc)).replace("{image}", encodeURIComponent(this.pageImage));
                b.attr("href", c)
            }
        },
        click: function(a) {
    ...
    XF.WebShare = XF.Element.newHandler({
        ...
        setupShareData: function() {
            this.fetchUrl || (this.options.url ? this.url = this.options.url : (this.url = e('meta[property="og:url"]').attr("content"), this.url || (this.url = l.location.href)), this.options.title ? this.title = this.options.title : (this.title = e('meta[property="og:title"]').attr("content"), this.title || (this.title = e("title").text())), this.options.text ? this.text = this.options.text : (this.text = e('meta[property="og:description"]').attr("content"), this.text || (this.text = e("meta[name=description]").attr("content") || "")))
        },
        click: function(a) {
            a.preventDefault();
            if (this.fetchUrl) {
...
! function(e, p, q) {
    ...
    XF.AjaxSubmit = XF.Element.newHandler({
        ...
        submitResponse: function(a, b, c) {
            if ("object" != typeof a) XF.alert("Response was not JSON.");
                ...
                if (!d.isDefaultPrevented()) {
                    ...
                    if (a.errorHtml) b.trigger(d, a, this), d.isDefaultPrevented() || XF.setupHtmlInsert(a.errorHtml, function(l, n) {
                    ...
                    }), f = !0) : XF.redirect(a.redirect) : (XF.flashMessage(a.message, 3E3), f = !0), k && k.trigger("overlay:hide");
                    else if (a.html) {
                        var m = this;
                    ...
                    b.trigger(d, a, this);
                    d.isDefaultPrevented() || this.options.resetComplete && !g && b[0].reset()
                }
            }
        },
        doSubmitReplace: function(a, b) {
            ...
            this.options.showReplacement ? (f.hide().insertAfter(g), g.xfFadeUp(null, function() {
                g.remove();
    ...
    XF.SelectPlus = XF.Element.newHandler({
        ...
        checkboxEnter: function(a) {
            this.isActive && (this.lastEntered = this.$checkboxes.index(e(a.delegateTarget).find("input:checkbox").eq(0)), this.isShifted && this.redrawHover())
        },
        keydown: function(a) {
    ...
    XF.Disabler = XF.Element.newHandler({
        ...
        recalculate: function(a, b) {
            ...
            d.is(":enabled") && (d.is(":checked") && !this.options.invert || this.options.invert && !d.is(":checked")) ? (c.prop("disabled", !1).removeClass("is-disabled"), g.prop("disabled", !1).removeClass("is-disabled").each(function(m, l) {
                ...
                XF.layoutChange();
                k()
            }), c.trigger("toggle:shown"), XF.layoutChange()) : a || k()) : (this.options.hide && (a ? c.hide() : c.slideUp(f, XF.layoutChange), c.trigger("toggle:hidden"), XF.layoutChange()), c.prop("disabled", !0).addClass("is-disabled"), g.prop("disabled", !0).addClass("is-disabled").trigger("control:disabled").each(function(m, l) {
                m = e(l);
                l = m.data("disabled");
    ...
    XF.FieldAdder = XF.Element.newHandler({
        ...
        init: function() {
            this.$target.find("input:not(:checkbox), select, textarea").each(function() {
                var b = e(this);
                b.is("select") ? b.find("option").each(function() {
    ...
    XF.FormSubmitRow = XF.Element.newHandler({
        ...
        init: function() {
            if (XF.config.enableFormSubmitSticky) {
                ...
                b.length ? (this.$container = b, this.topOffset = this.options.topOffset, this.$fixEl = a.find(this.options.fixedChild), e(p).on("scroll", XF.proxy(this, "onScroll")).on("resize", XF.proxy(this, "recalcAndUpdate")), b = XF.getFixedOffsetParent(a), b.is("html") || (this.$fixedParent = b, b.on("scroll", XF.proxy(this, "onScroll"))), e(q.body).on("xf:layout", XF.proxy(this, "recalcAndUpdate")), a.height() || setTimeout(XF.proxy(this, "recalcAndUpdate"), 250), this.recalcAndUpdate()) : console.error("Cannot float submit row, no container")
            }
        },
        recalc: function() {
            var a = this.$target;
    ...
    XF.PermissionMatrix = XF.Element.newHandler({
        ...
        update: function() {
            ...
            var a = this.$target.find(this.options.inputSelector + ":checked").val(); - 1 < e.inArray(a, this.values) && (this.currentClass = this.options.classPrefix + this.options.permissionType + "-" + a, this.$parentRow.addClass(this.currentClass))
        }
    });
    XF.MultiCheck = XF.Event.newHandler({
        ...
        init: function() {
            ...
            this.currentValue = 0 < e.inArray(a, this.values) ? this.values[-1] : this.values[0]
        },
        click: function(a) {
    ...
    XF.NumberBox = XF.Element.newHandler({
        ...
        setupButton: function(a, b) {
            a.on("focus", XF.proxy(this, "buttonFocus")).on("click", XF.proxy(this, "buttonClick")).on("mousedown touchstart", XF.proxy(this, "buttonMouseDown")).on("mouseleave mouseup touchend", XF.proxy(this, "buttonMouseUp")).on("touchend", function(c) {
                c.preventDefault();
                e(this).click()
            }).insertAfter(b)
        },
...
! function(f, m, q) {
    ...
    XF.MenuClick = XF.Event.newHandler({
                ...
                if (b.data("href")) {
                    if (!b.data("menu-loading")) {
                        ...
                        XF.ajax("get", b.data("href"), {}, function(l) {
                            k && b.data("href", !1);
                            l.html && XF.setupHtmlInsert(l.html, function(n, p, r) {
        ...
        getHorizontalPosition: function(a, b) {
            var c = !1,
                d = 0;
            this.menuWidth > a.width ? d = this.menuRef.left - a.left : this.menuRef.left + this.menuRef.width / 2 > a.width * this.options.directionThreshold ? (d = 0 - this.menuWidth + this.menuRef.width, c = !0) : this.menuRef.width > this.menuWidth && (d = Math.floor((this.menuRef.width - this.menuWidth) / 2));
    ...
    XF.ToggleStorageDataInstance = XF.create({
        ...
        get: function(a, b, c) {
            ...
            if (!d && c[0] + c[1] < g) return delete this.dataCache[a][b], this.scheduleSync(a), null;
    ...
    XF.TouchProxy = XF.Element.newHandler({
        ...
        init: function() {
            ...
            if ("InputDeviceCapabilities" in m || "sourceCapabilities" in UIEvent.prototype) this.$target.click(function(c) {
                ...
                d && d.sourceCapabilities && d.sourceCapabilities.firesTouchEvents && a.handleTapEvent(c)
            });
...
! function(f, m, p) {
    ...
    XF.TooltipTrigger = XF.create({
        ...
        init: function() {
            ...
            if (!b && this.options.clickHide) a.onPointer("click.tooltip auxclick.tooltip contextmenu.tooltip", function(e) {
                c && XF.isEventTouchTriggered(e) || (d.hide(), d.stopFocusBefore = Date.now() + 2E3)
            });
            a.on({
        ...
        addCovers: function() {
            ...
            a = f();
            for (var c, d = 0; d < b.length; d++) c = f('<div class="tooltipCover" />').css(b[d]), a = a.add(c);
    ...
    XF.Tooltip = XF.Element.newHandler({
        ...
        getContent: function() {
            ...
            a.attr("aria-label") || a.attr("aria-labelledby") || f.trim(a[0].textContent).length || a.attr("aria-label", b);
            return b
        },
        refresh: function() {
